    ...
    <section id="blog" class="container section">
            ...
            <div class="blog__inner">
                <div class="blog__write">
                    <form action="blogWriteSave.php" name="blogWrite" method="post">
                        <fieldset>
                            <legend>게시판 작성 영역</legend>
                            <div>
                                <label for="blogCategory">카테고리</label>
                                <select name="blogCategory" id="blogCate" class="select_style1">
                            ...
                            <div>
                                ...
                                <input type="file" accept="image/jpeg, image/png, image/jpg, image/png, image/gif" name="blogFile" id="blogFile"> 
                            </div>
